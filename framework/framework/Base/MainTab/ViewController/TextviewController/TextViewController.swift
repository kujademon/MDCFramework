...
class TextViewController: BaseTableViewController {
    ...
    var exampleList = [
        Example(title: "Default", subTitle: "TextViewDefaultController"),
        Example(title: "Custom", subTitle: "TextViewCustomController")
    ]
