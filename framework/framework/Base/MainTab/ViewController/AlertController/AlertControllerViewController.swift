...
class AlertControllerViewController: UITableViewController {
    ...
    private let cellReuseIdentifier = "AlertControllerTableViewCell"
    
    weak var secureTextAlertAction: UIAlertAction?
    
    
    let key = ["Alert style","Action sheet style"]
    let value = ["Alert style":["Simple","OK / Cancel","Three Buttons","Text Entry","Secure Text Entry"],"Action sheet style":["Confirm / Cancel","Destructive"]]
...
extension AlertControllerViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let key = self.key[indexPath.section]
        let tableSection = self.value[key]
