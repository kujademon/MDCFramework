...
class PickerViewController: UIViewController {
    ...
    lazy var colorSwatchView: UIView = {
        [unowned self] in
    ...
    fileprivate func setupView(){
        ...
        view.addSubview(colorSwatchView)
        
        view.addConstraints(with: "H:|-left-[v0]-right-|", to: pickerView, constraintCollector: &constraintCollector)
        view.addConstraints(with: "H:|-10-[v0]-10-|", to: colorSwatchView, constraintCollector: &constraintCollector)
        view.addConstraints(with: "V:|-top-[v0(\(self.view.bounds.height * 0.3))][v1]-20-|", to: pickerView,colorSwatchView, constraintCollector: &constraintCollector)
    }
